...
const Maps = () => {
  ...
  useEffect(() => {
    ...
    document.getElementById('map')?.childNodes.forEach((child: any) => {
      if (child.getAttribute('data-set')) {
        res.push(child.getAttribute('data-set'));
      }
    });
      ...
      {true ? (
        <Box>
          ...
          >
            ...
            >
              <path
                d='M536.6 967.4l6.4 1.6 9.6 2 4.2 2.9 3.9 1.5 1.8 4.2 14.7 24.9 6.9 23.6-5.2 14.6-13.7 9-18.9 0-18.9-3.6-5.2-7.3-15.4-1.8-17.2 3.7-17.2 10.9-12 12.7-10.3 1.8-13.7-3.6-32.6 5.5 13.7-20.1 20.6-25.4 13.7-21.8 6.9-25.5 13.7-12.6 13.8-1.9 22.3 1.9 28.1 2.8z'
                id='MDG5875'
                name='Itasy'
                data-set='Miarinarivo'
              ></path>
            </Tooltip>
            <Tooltip
              label={
